<main>
    <section class="post-title-sec d-flex justify-content-center align-items-center" style="background-image: url('{{asset($post->image)}}');">
        <div class="container text-center">
            <div class="title-content">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <img class="rounded-circle" src="{{asset($post->user->image)}}" alt="{{$post->user->name}}" style="width: 65px;">
                    <div class="p-3">
